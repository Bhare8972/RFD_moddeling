...
const double electron_rest_energy=510.998*Kilo*elementary_charge;   //(9.1093835e-31)*C*C; is in joules
...
const double energy_units_kev=510.998; //units of energy in terms of keV. also mass of electon in Kev
