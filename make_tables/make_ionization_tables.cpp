...
4, 6, 10, 12.5, 15.0, 17.5, 20.0, 25.0, 30.0, 35.0, 40.0, 54.0, 50.0, 55.0,
60.0, 70.0, 80.0, 90.0, 100, 125,150,175,200, 250, 300, 350, 400, 450, 500, 
550, 600, 700, 800, 900, 1000, 1250, 1500, 1750, 2000, 250, 3000, 3500, 
4000, 4500, 5000, 5500, 6000, 7000, 8000, 9000, 10000, 12500, 1500, 17500, 
20000, 25000, 30000, 35000});

//stopping power of electrons for energies in electron_energy, in units of MeV cm^2 g^-1
gsl::vector_float electron_SP({26.0, 104, 170, 218, 216, 170, 139, 97.9, 65.8, 
...
gsl::vector_float positron_energy({100, 125, 150, 175, 200, 250, 300, 350, 400, 450, 
500, 550, 600, 700, 800, 900, 1000, 1250, 1500, 1750, 2000, 250, 3000, 3500, 
4000, 4500, 5000, 5500, 6000, 7000, 8000, 9000, 10000, 12500, 1500, 17500, 
20000, 25000, 30000, 35000});

//stopping power of position for energies in positron_energy, in units of MeV cm^2 g^-1
gsl::vector_float positron_SP({21.8, 18.25, 15.78, 13.96, 12.56, 10.53, 9.126, 
...
int main()
{
	...
	shared_ptr<floats_output> electron_SP_table(new floats_output(electron_SP));
	shared_ptr<floats_output> positron_energy_table(new floats_output(positron_mom_sq));
	shared_ptr<floats_output> positron_SP_table(new floats_output(positron_SP));
	...
	binary_output fout("./ionization_losses");
