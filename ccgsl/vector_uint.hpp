...
namespace gsl {
   ...
   *
   * If you want to use a std::vector<unsigned int> or similar object as if it were a gsl::vector_uint object,
   * use the constructor that takes a stride argument. But use it with caution.
   * Changing the size of the original object does not change the size of the gsl::vector_uint object; so it
   * may be safer to create gsl::vector_uint objects in this way as needed.
   */
  class vector_uint {
  public:
    /**
    ...
    explicit vector_uint( size_t const n ){
      if( n > 0 ) ccgsl_pointer = gsl_vector_uint_alloc( n );
      else { ccgsl_pointer = new gsl_vector_uint; ccgsl_pointer->size = 0; ccgsl_pointer->data = 0; }
      // just plausibly we could allocate vector_uint but not count
      try { count = new size_t; } catch( std::bad_alloc& e ){
	// try to tidy up before rethrowing
	if( n > 0 ) gsl_vector_uint_free( ccgsl_pointer );
    ...
    vector_uint( vector_uint const& v ) : ccgsl_pointer( v.ccgsl_pointer ), count( v.count ){
      if( count != 0 ) ++*count; // vector_uint is now shared.
    }
    /**
     * The copy constructor. This shares the vector_uint. Use clone() if you want a full copy.
     * @param v The vector_uint to copy.
     */
    vector_uint( vector_uint& v ) : ccgsl_pointer( v.ccgsl_pointer ), count( v.count ){
      if( count != 0 ) ++*count; // vector_uint is now shared.
    }
    // assignment operator
    /**
	...
	if( ccgsl_pointer != 0 ){
	  if( ccgsl_pointer->size > 0 ) gsl_vector_uint_free( ccgsl_pointer );
	  else delete ccgsl_pointer; }
	delete count;
      }
      // Then copy
     ...
     * to allow you to construct from a std::vector<unsigned int> or std::array<unsigned int,size_t> object.
     ...
     * the size of the gsl::vector_uint does not change. Stride is normally set to 1 and allows us
     ...
     */
    template<typename V> vector_uint( V& v, size_t const stride = 1 ){
      size_t const n = v.size() / stride;
      ccgsl_pointer = static_cast<gsl_vector_uint*>( malloc( sizeof( gsl_vector_uint ) ) );
    ...
    // Allow possibility of assigning from gsl_vector_uint without sharing
    /**
     * This function is intended mainly for internal use. It allows @c this
     * to point to a gsl_vector_uint without the possibility deleting it when @c this
     ...
     * gsl::vector_uint* argument to one that takes a gsl_vector_uint* argument.
     * @param v The gsl_vector_uint
     */
     ...
     */
    void reset(){ vector_uint().swap( *this ); }
#ifdef __GXX_EXPERIMENTAL_CXX0X__
    /**
     * Move constructor.
     * @param v The vector_uint to move.
     */
    vector_uint( vector_uint&& v ) : ccgsl_pointer( v.ccgsl_pointer ), count( nullptr ){
    ...
    vector_uint& operator=( vector_uint&& v ){
      vector_uint( std::move( v ) ).swap( *this );
      return *this;
    }
#endif
    // != operator
  ...
  public:
     ...
     * a GSL error if the vector_uint stride is not 1. However, new vector_uint objects are always initialised
	...
	gsl_error( "vector_uint does not have stride of size 1", __FILE__, __LINE__, GSL_EBADLEN );
#endif
    ...
    unsigned int& operator[]( size_t const n ){
      ...
      // First check that iterator is initialised.
      if( ccgsl_pointer == 0 ){
  	gsl_error( "vector_uint is null", __FILE__, __LINE__, exception::GSL_EFAULT );
  	return something;
      }
#ifndef GSL_RANGE_CHECK_OFF
      // Check that position make sense
      if( n >= size() ){
  	gsl_error( "trying to read beyond end of vector_uint", __FILE__, __LINE__, exception::GSL_EINVAL );
  	return something;
      }
  ...
  public:
     ...
     */
    gsl_vector_uint* get() { return ccgsl_pointer; }
    /**
     * Get the gsl_vector_uint.
     * @return the gsl_vector_uint
     */
    gsl_vector_uint const* get() const { return ccgsl_pointer; }
    /**
    ...
    /**
     * Another C++ version of gsl_vector_uint_const_view_array().
     * @param v An array of type unsigned int
     * @param n The size of the vector_uint
     * @return A vector_uint
     */
    static vector_uint const view_array( unsigned int const* v, size_t n ){
      gsl_vector_uint* w = static_cast<gsl_vector_uint*>( malloc( sizeof( gsl_vector_uint ) ) );
      *w = gsl_vector_uint_const_view_array( v, n ).vector;
      return vector_uint( w );
    }
    /**
     * Another C++ version of gsl_vector_uint_const_view_array_with_stride().
     * @param base An array of type unsigned int
     * @param stride The stride
     * @param n The size of the vector_uint
     * @return A vector_uint
     */
    static vector_uint const view_array_with_stride( unsigned int const* base, size_t stride, size_t n ){
      gsl_vector_uint* w = static_cast<gsl_vector_uint*>( malloc( sizeof( gsl_vector_uint ) ) );
      *w = gsl_vector_uint_const_view_array_with_stride( base, stride, n ).vector;
      return vector_uint( w );
    }
    ...
    /**
     * Another C++ version of gsl_const_vector_uint_subvector_with_stride().
     * @param i The offset
     * @param n The size
     * @return A subvector
     */
    vector_uint const subvector( size_t i, size_t n ) const {
      gsl_vector_uint* w = static_cast<gsl_vector_uint*>( malloc( sizeof( gsl_vector_uint ) ) );
      *w = gsl_vector_uint_const_subvector( get(), i, n ).vector;
      return vector_uint( w );
    }
    /**
     * Another C++ version of gsl_vector_uint_const_subvector_with_stride().
     * @param i The offset
     * @param stride The stride
     * @param n The size
     * @return A subvector
     */
    vector_uint const subvector_with_stride( size_t i, size_t stride, size_t n ) const {
      gsl_vector_uint* w = static_cast<gsl_vector_uint*>( malloc( sizeof( gsl_vector_uint ) ) );
      *w = gsl_vector_uint_const_subvector_with_stride( get(), i, stride, n ).vector;
      return vector_uint( w );
    }
