...
namespace gsl {
  ...
  public:
     ...
     * you should not use gsl_matrix_complex_free() to deallocate the memory.
    ...
    /**
     * Move constructor.
     * @param v The matrix_complex to move.
     */
  ...
  private:
    ...
    struct vector_complex_ptr : public vector_complex {
       ...
       * @param v The vector_complex to construct from.
       */
      ...
      /**
       * Dereference operator.
       * @return a pointer to a vector_complex
       */
      vector_complex* operator->(){ return this; }
    };
    /**
    ...
    public:
       ...
       */
      iterator_t<reverse_t>() : iterator_base<matrix_complex,vector_complex,reverse_t>(){}
    protected:
      friend class matrix_complex;
      // We need a constructor for matrix_complex
      /**
       * This constructor allows vector to create non-default iterators.
       * @param v The matrix_complex that creates @c this
       * @param position The initial postion of the iterator
       */
      iterator_t<reverse_t>( matrix_complex* v, size_t position )
    ...
    public:
       ...
       * The default constructor.
       */
      const_iterator_t<reverse_t>() : iterator_base<matrix_complex,vector_complex,reverse_t>(){}
      /**
       * A copy constructor
    ...
    protected:
       ...
       * @param position The initial postion of the iterator
       */
      const_iterator_t<reverse_t>( matrix_complex const* v, size_t position )
