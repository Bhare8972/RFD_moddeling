...
namespace gsl {
  namespace fft {
	 ...
	 * @param data An array of halfcomplex values as an array of float values.
	 ...
	 * you should not use gsl_fft_halfcomplex_wavetable_float_free() to deallocate the memory.
	 ...
	 * @return the gsl_fft_halfcomplex_wavetable_float
	 */
	 ...
	 * this is the only workspace object sharing the gsl_fft_halfcomplex_wavetable_float
	 */
	 ...
	 * to a gsl_fft_halfcomplex_wavetable_float
	 */
#ifdef __GXX_EXPERIMENTAL_CXX0X__
	explicit
#endif
	...
	return gsl_fft_halfcomplex_float_inverse( data, stride, n, wavetable.get(), work.get() ); }
       ...
       * @param real_coefficient An array of float values.
