...
namespace gsl {
   ...
   * Otherwise,
   * @code
   * for( matrix_char::iterator i = matrix_char.begin(); i != matrix_char.end(); ++i ){
   *   vector_char row = *i;
   *   ...
   * }
   * @endcode
   ...
   * i-> ...
   * @endcode
   * because each call of @c operator->() creates a new and different vector_char.
   */
  class matrix_char {
  public:
    /**
     ...
     * you should not use gsl_matrix_char_free() to deallocate the memory.
     ...
     * to point to a gsl_matrix_char without the possibility deleting it when @c this
     ...
     * gsl::matrix_char* argument to one that takes a gsl_matrix_char* argument.
     * @param v The gsl_matrix_char
     */
    ...
    /**
     * Move constructor.
     * @param v The matrix_char to move.
     */
    matrix_char( matrix_char&& v ) : ccgsl_pointer( v.ccgsl_pointer ), count( nullptr ){
  ...
  private:
    ...
    struct vector_char_ptr : public vector_char {
       ...
       * @param v The vector_char to construct from.
       */
      ...
      /**
       * Dereference operator.
       * @return a pointer to a vector_char
       */
      vector_char* operator->(){ return this; }
    };
    /**
    ...
    protected:
       ...
       * @param v The matrix_char that creates @c this
    ...
    public:
       ...
       */
      iterator_t<reverse_t>() : iterator_base<matrix_char,vector_char,reverse_t>(){}
    protected:
       ...
       * @param position The initial postion of the iterator
       */
      iterator_t<reverse_t>( matrix_char* v, size_t position )
    ...
    public:
       ...
       * The default constructor.
       */
      const_iterator_t<reverse_t>() : iterator_base<matrix_char,vector_char,reverse_t>(){}
      /**
       * A copy constructor
    ...
    protected:
       ...
       * @param position The initial postion of the iterator
       */
      const_iterator_t<reverse_t>( matrix_char const* v, size_t position )
  ...
  public:
     ...
     * a GSL error if the matrix_char size2 and tda are not equal.
     * However, new matrix_char objects are always initialised to have tda and size2 equal.
     ...
     * Give access to the data block_char. The data() and size() functions mimic the functions
     * of std::array<T> and std::vector<T>. This function can throw an exception or produce
     * a GSL error if the matrix_char size1 and tda are not equal.
     * However, new matrix_char objects are always initialised to have tda and size2 equal.
     * @return The data block_char.
     */
  ...
  public:
     ...
     * Although @c matrix_char[i][j] is possible, it is less efficient than
