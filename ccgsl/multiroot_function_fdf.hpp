...
namespace gsl {
  namespace multiroot {
    /**
     * Class that extends gsl_multiroot_function_fdf so that it can be constructed
     * from arbitrary function objects. Since gsl::multiroot::function_fdf
     * is a subclass of gsl_multiroot_function_fdf,
     * a pointer to an object of this class can be used whenever a pointer
     * to a gsl_multiroot_function_fdf
     * object is required. Thus, pointers to objects of this class can be
     * used directly with the GNU
     * Scientific Library.
     *
     * A multiroot::function_fdf with argument a vector of length @em n should compute and return
     * @em n function values. In C++ it is straightforward to set up a class with
     * a member function that
     * implements multiroot::function_fdf::concept to get a suitable function object.
     * The multiroot::function_fdf can
	...
	size_t const n;
	/**
	 * A static function that gsl::multiroot::function_fdf can use.
	 * This function must not be called in two threads at once.
	 * @param x The arguments of the functions.
	...
	count = 0; // initially nullptr will do
       ...
       * gsl::multiroot::function_fdf<T>() will construct the object correctly.
       * @param v The gsl_multiroot_function_fdf.
       */
	...
	*count = 1; // initially there is just one reference to function
       ...
       * @param t An object that implements gsl::multiroot::function_fdf::concept.
       */
      template<typename T>
	...
	*count = 1; // initially there is just one reference to function
       ...
       * gsl::multiroot::function_fdf::multiroot::function_fdf<T>()
    ...
    /**
     * Specialisation for gsl_multiroot_function_fdf.
     * @param f The function_fdf.
     ...
     * gsl_multiroot_function_fdf object; and copy construction.
    ...
    /**
     * Make a gsl::multiroot::function_fdf from a function object
     * that implements gsl::multiroot::function_fdf::concept.
