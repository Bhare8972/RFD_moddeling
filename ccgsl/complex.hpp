/*
 * $Id: complex.hpp 77 2012-01-15 15:32:13Z jdl3 $
...
namespace gsl {
 ...
 public:
     ...
     * @return std::complex<double> version of this (by copying).
     */
#ifdef __GXX_EXPERIMENTAL_CXX0X__
    explicit operator std::complex<double>() const {
      return std::move( std::complex<double>( GSL_REAL( *this ), GSL_IMAG( *this ) ) );
    }
#else
      operator std::complex<double>() const {
      std::complex<double> z = std::complex<double>( GSL_REAL( *this ), GSL_IMAG( *this ) );
      return z;
    }
#endif      
    /**
