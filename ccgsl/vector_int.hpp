...
namespace gsl {
   ...
   *
   * If you want to use a std::vector<int> or similar object as if it were a gsl::vector_int object,
   * use the constructor that takes a stride argument. But use it with caution.
   * Changing the size of the original object does not change the size of the gsl::vector_int object; so it
   * may be safer to create gsl::vector_int objects in this way as needed.
   */
  class vector_int {
  public:
    /**
     ...
     * @param v The vector_int to copy.
     */
    vector_int( vector_int& v ) : ccgsl_pointer( v.ccgsl_pointer ), count( v.count ){
      if( count != 0 ) ++*count; // vector_int is now shared.
    }
    // assignment operator
    /**
     ...
     * to allow you to construct from a std::vector<int> or std::array<int,size_t> object.
     ...
     * the size of the gsl::vector_int does not change. Stride is normally set to 1 and allows us
     ...
     */
    template<typename V> vector_int( V& v, size_t const stride = 1 ){
     ...
     * to point to a gsl_vector_int without the possibility deleting it when @c this
     ...
     * gsl::vector_int* argument to one that takes a gsl_vector_int* argument.
     * @param v The gsl_vector_int
     */
    ...
    /**
     * Move constructor.
     * @param v The vector_int to move.
     */
    vector_int( vector_int&& v ) : ccgsl_pointer( v.ccgsl_pointer ), count( nullptr ){
  ...
  public:
     ...
     * a GSL error if the vector_int stride is not 1. However, new vector_int objects are always initialised
  ...
  public:
    ...
    /**
     * Another C++ version of gsl_vector_int_const_view_array().
     * @param v An array of type int
     * @param n The size of the vector_int
     * @return A vector_int
     */
    ...
    /**
     * Another C++ version of gsl_vector_int_const_view_array_with_stride().
     * @param base An array of type int
     * @param stride The stride
     * @param n The size of the vector_int
     * @return A vector_int
    ...
    /**
     * Another C++ version of gsl_const_vector_int_subvector_with_stride().
     * @param i The offset
     * @param n The size
     * @return A subvector
     */
    ...
    /**
     * Another C++ version of gsl_vector_int_const_subvector_with_stride().
     * @param i The offset
     * @param stride The stride
     * @param n The size
     * @return A subvector
