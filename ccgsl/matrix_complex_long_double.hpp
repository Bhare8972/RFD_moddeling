/*
 * $Id: matrix_complex_long_double.hpp 313 2014-02-22 14:29:57Z jdl3 $
...
namespace gsl {
   ...
   * Otherwise,
   * @code
   * for( matrix_complex_long_double::iterator i = matrix.begin(); i != matrix.end(); ++i ){
   *   vector_complex_long_double row = *i;
   *   ...
   * }
   * @endcode
  ...
  public:
    ...
    explicit matrix_complex_long_double( size_t const n1, size_t const n2 ){
      if( n1 > 0 and n2 > 0 ) ccgsl_pointer = gsl_matrix_complex_long_double_alloc( n1, n2 );
      else { ccgsl_pointer = new gsl_matrix_complex_long_double; ccgsl_pointer->size1 = n1;
	ccgsl_pointer->size2 = n2; ccgsl_pointer->data = 0; }
      // just plausibly we could allocate matrix but not count
      try { count = new size_t; } catch( std::bad_alloc& e ){
	// try to tidy up before rethrowing
	if( n1 > 0 and n2 > 0 ) gsl_matrix_complex_long_double_free( ccgsl_pointer );
     ...
     * you should not use gsl_matrix_complex_long_double_free() to deallocate the memory.
    ...
    matrix_complex_long_double( matrix_complex_long_double const& v ) : ccgsl_pointer( v.ccgsl_pointer ), count( v.count ){
      if( count != 0 ) ++*count; // matrix_complex_long_double is now shared.
    }
    // assignment operator
    /**
	...
	if( ccgsl_pointer != 0 and ccgsl_pointer->size1 > 0 and ccgsl_pointer->size2 > 0 ) gsl_matrix_complex_long_double_free( ccgsl_pointer );
	else delete ccgsl_pointer;
	delete count;
      }
      // Then copy
	...
	if( ccgsl_pointer != 0 ){
	  if( ccgsl_pointer->size1 > 0 and ccgsl_pointer->size2 > 0 ) gsl_matrix_complex_long_double_free( ccgsl_pointer );
	  else delete ccgsl_pointer; }
	delete count;
      }
    }
     ...
     */
    void reset(){ matrix_complex_long_double().swap( *this ); }
#ifdef __GXX_EXPERIMENTAL_CXX0X__
    /**
     * Move constructor.
     * @param v The matrix_complex_long_double to move.
     */
    matrix_complex_long_double( matrix_complex_long_double&& v ) : ccgsl_pointer( v.ccgsl_pointer ), count( nullptr ){
    ...
    matrix_complex_long_double& operator=( matrix_complex_long_double&& v ){
      matrix_complex_long_double( std::move( v ) ).swap( *this );
      return *this;
    }
#endif
  private:
     ...
     */
    struct vector_complex_long_double_ptr : public vector_complex_long_double {
      /**
       * Typically we have to construct from a vector_complex_long_double.
       * @param v The vector_complex_long_double to construct from.
       */
      vector_complex_long_double_ptr( vector_complex_long_double const& v ) : vector_complex_long_double( v ){}
      /**
       * Dereference operator.
       * @return a vector_complex
       */
      vector_complex_long_double& operator*(){ return *this; }
      /**
       * Dereference operator.
       * @return a pointer to a vector_complex_long_double
       */
      vector_complex_long_double* operator->(){ return this; }
    };
    /**
	...
	static vector_complex_long_double_ptr something( something_base );
  	// First check that iterator is initialised.
  	if( v == 0 ){
  	  gsl_error( "iterator not initialised", __FILE__, __LINE__, exception::GSL_EFAILED );
  	  return something;
  	...
  	// position and v are valid: return data
  	vector_complex_long_double_ptr ptr( v->row( position ) );
#ifdef __GXX_EXPERIMENTAL_CXX0X__
  	return std::move( ptr );
#else
  	return ptr;
     ...
     */
    template<bool reverse_t> class iterator_t : public iterator_base<matrix_complex_long_double,vector_complex_long_double,reverse_t>{
    public:
  	...
  	iterator_base<matrix_complex_long_double,vector_complex_long_double,reverse_t>::v = i.v;
  	iterator_base<matrix_complex_long_double,vector_complex_long_double,reverse_t>::position = i.position;
  	return *this;
      }
  	...
  	iterator_base<matrix_complex_long_double,vector_complex_long_double,reverse_t>::increment();
  	return *this;
      }
      /**
       ...
       */
      iterator_t<reverse_t>& operator--(){
  	iterator_base<matrix_complex_long_double,vector_complex_long_double,reverse_t>::decrement();
  	return *this;
      }
      /**
       * The postfix -- operator.
       ...
       */
      iterator_t<reverse_t>() : iterator_base<matrix_complex_long_double,vector_complex_long_double,reverse_t>(){}
    protected:
      friend class matrix_complex_long_double;
      // We need a constructor for matrix_complex_long_double
      /**
       * This constructor allows vector to create non-default iterators.
       * @param v The matrix_complex_long_double that creates @c this
       * @param position The initial postion of the iterator
       */
      iterator_t<reverse_t>( matrix_complex_long_double* v, size_t position )
      : iterator_base<matrix_complex_long_double,vector_complex_long_double,reverse_t>( v, position ){}
    };
    /**
    ...
    public:
  	...
  	iterator_base<matrix_complex_long_double const,vector_complex_long_double const,reverse_t>::v = i.v;
  	iterator_base<matrix_complex_long_double const,vector_complex_long_double const,reverse_t>::position = i.position;
  	return *this;
      }
      // // Refines forward iterator
      // // operator++ (both)
  	...
  	iterator_base<matrix_complex_long_double const,vector_complex_long_double const,reverse_t>::increment();
  	return *this;
      }
      /**
       * The postfix ++ operator.
       ...
       */
      const_iterator_t<reverse_t>& operator--(){
  	iterator_base<matrix_complex_long_double const,vector_complex_long_double const,reverse_t>::decrement();
  	return *this;
      }
      /**
       * The postfix -- operator.
       ...
       * The default constructor.
       */
      const_iterator_t<reverse_t>() : iterator_base<matrix_complex_long_double,vector_complex_long_double,reverse_t>(){}
      /**
       * A copy constructor
    ...
    protected:
       ...
       * @param position The initial postion of the iterator
       */
      const_iterator_t<reverse_t>( matrix_complex_long_double const* v, size_t position )
      : iterator_base<matrix_complex_long_double const,vector_complex_long_double const,reverse_t>( v, position ){}
    };
  public:
    /**
  ...
  public:
    ...
    const_view_array_with_tda( long double const* base, size_t const n1, size_t const n2, size_t const tda ){
      gsl_matrix_complex_long_double* m = static_cast<gsl_matrix_complex_long_double*>( malloc( sizeof( gsl_matrix_complex_long_double ) ) );
     ...
     */
    static matrix_complex_long_double const
    const_view_vector_with_tda( vector_complex_long_double const& v, size_t const n1, size_t const n2, size_t const tda ){
      gsl_matrix_complex_long_double* m = static_cast<gsl_matrix_complex_long_double*>( malloc( sizeof( gsl_matrix_complex_long_double ) ) );
     ...
     */
    static matrix_complex_long_double const
    view_array_with_tda( long double const* base, size_t const n1, size_t const n2, size_t const tda ){
      gsl_matrix_complex_long_double* m = static_cast<gsl_matrix_complex_long_double*>( malloc( sizeof( gsl_matrix_complex_long_double ) ) );
      *m =  gsl_matrix_complex_long_double_const_view_array_with_tda( base, n1, n2, tda ).matrix;
      return matrix_complex_long_double( m );
    }
     ...
     */
    static matrix_complex_long_double const
    view_vector_with_tda( vector_complex_long_double const& v, size_t const n1, size_t const n2, size_t const tda ){
      gsl_matrix_complex_long_double* m = static_cast<gsl_matrix_complex_long_double*>( malloc( sizeof( gsl_matrix_complex_long_double ) ) );
      *m = gsl_matrix_complex_long_double_const_view_vector_with_tda( v.get(), n1, n2, tda ).matrix;
      return matrix_complex_long_double( m );
    }
  ...
  public:
     ...
     */
    gsl_matrix_complex_long_double* get(){ return ccgsl_pointer; }
    /**
     * Get the gsl_matrix_complex_long_double.
     * @return the gsl_matrix_complex_long_double
     */
    gsl_matrix_complex_long_double const* get() const { return ccgsl_pointer; }
    /**
  ...
  inline vector_complex_long_double vector_complex_long_double::alloc_row_from_matrix( matrix_complex_long_double& m, size_t const i ){
    return vector_complex_long_double ( gsl_vector_complex_long_double_alloc_row_from_matrix( m.get(), i ) ); }
  inline vector_complex_long_double vector_complex_long_double::alloc_col_from_matrix( matrix_complex_long_double& m, size_t const i ){
