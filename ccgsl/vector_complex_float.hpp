/*
 * $Id: vector_complex_float.hpp 314 2014-02-22 14:31:16Z jdl3 $
...
namespace gsl {
  ...
  public:
    ...
    explicit vector_complex_float( size_t const n ){
      if( n > 0 ) ccgsl_pointer = gsl_vector_complex_float_alloc( n );
      else { ccgsl_pointer = new gsl_vector_complex_float; ccgsl_pointer->size = 0; ccgsl_pointer->data = 0; }
      // just plausibly we could allocate vector_complex_float but not count
      try { count = new size_t; } catch( std::bad_alloc& e ){
	// try to tidy up before rethrowing
	if( n > 0 ) gsl_vector_complex_float_free( ccgsl_pointer );
     ...
     * you should not use gsl_vector_complex_float_free() to deallocate the memory.
    ...
    vector_complex_float( std::initializer_list<std::complex<float> > initializer_list ){
      ...
      ccgsl_pointer = gsl_vector_complex_float_alloc( n );
	...
	*p = complex_float( std::move( x ) ); ++p;
    ...
    vector_complex_float( vector_complex_float const& v ) : ccgsl_pointer( v.ccgsl_pointer ), count( v.count ){
      if( count != 0 ) ++*count; // vector_complex_float is now shared.
    }
    // assignment operator
    /**
	...
	if( ccgsl_pointer != 0 ){
	  if( ccgsl_pointer->size > 0 ) gsl_vector_complex_float_free( ccgsl_pointer );
	  else delete ccgsl_pointer; }
	delete count;
      }
      // Then copy
    ...
    // clone()
    /**
     * The clone function. Use this if you want a copy of the vector_complex_float that does
     ...
     */
    void reset(){ vector_complex_float().swap( *this ); }
#ifdef __GXX_EXPERIMENTAL_CXX0X__
    /**
     * Move constructor.
     * @param v The vector_complex_float to move.
     */
    vector_complex_float( vector_complex_float&& v ) : ccgsl_pointer( v.ccgsl_pointer ), count( nullptr ){
    ...
    vector_complex_float& operator=( vector_complex_float&& v ){
      vector_complex_float( std::move( v ) ).swap( *this );
      return *this;
    }
#endif
    // != operator
  ...
  public:
     ...
     */
    gsl_vector_complex_float* get() { return ccgsl_pointer; }
    /**
     * Get the gsl_vector_complex_float.
     * @return the gsl_vector_complex_float
     */
    gsl_vector_complex_float const* get() const { return ccgsl_pointer; }
    /**
    ...
    gsl::vector_float real(){
      return gsl::vector_float::view_array_with_stride( data(), CCGSL_MTY, size()  ); }
    /**
    ...
    gsl::vector_float const const_real() const {
      return gsl::vector_float::const_view_array_with_stride( data(), CCGSL_MTY, size()  ); }
    /**
    ...
    gsl::vector_float imag(){
      return gsl::vector_float::view_array_with_stride( data() + CCGSL_MTY / 2, CCGSL_MTY, size()  ); }
    /**
    ...
    gsl::vector_float const const_imag() const {
      return gsl::vector_float::const_view_array_with_stride( data() + CCGSL_MTY / 2, CCGSL_MTY, size()  ); }
    /**
    ...
    /**
     * Another C++ version of gsl_vector_complex_float_const_view_array().
     * @param v An array of type float
     * @param n The size of the vector_complex_float
     * @return A vector_complex_float
     */
    static vector_complex_float const view_array( float const* v, size_t n ){
      gsl_vector_complex_float* w = static_cast<gsl_vector_complex_float*>( malloc( sizeof( gsl_vector_complex_float ) ) );
      *w = gsl_vector_complex_float_const_view_array( v, n ).vector;
      return vector_complex_float( w );
    }
    /**
     * Another C++ version of gsl_vector_complex_float_const_view_array_with_stride().
     * @param base An array of type float
     * @param stride The stride
     * @param n The size of the vector_complex_float
     * @return A vector_complex_float
     */
    static vector_complex_float const view_array_with_stride( float const* base, size_t stride, size_t n ){
      gsl_vector_complex_float* w = static_cast<gsl_vector_complex_float*>( malloc( sizeof( gsl_vector_complex_float ) ) );
      *w = gsl_vector_complex_float_const_view_array_with_stride( base, stride, n ).vector;
      return vector_complex_float( w );
    }
    ...
    /**
     * Another C++ version of gsl_vector_complex_float_const_subvector().
     * @param i The offset
     * @param n The size
     * @return A subvector
     */
    vector_complex_float const subvector( size_t i, size_t n ) const {
      gsl_vector_complex_float* w = static_cast<gsl_vector_complex_float*>( malloc( sizeof( gsl_vector_complex_float ) ) );
      *w = gsl_vector_complex_float_const_subvector( get(), i, n ).vector;
      return vector_complex_float( w );
    }
    /**
     * Another C++ version of gsl_vector_complex_float_const_subvector_with_stride().
     * @param i The offset
     * @param stride The stride
     * @param n The size
     * @return A subvector
     */
    vector_complex_float const subvector_with_stride( size_t i, size_t stride, size_t n ) const {
      gsl_vector_complex_float* w = static_cast<gsl_vector_complex_float*>( malloc( sizeof( gsl_vector_complex_float ) ) );
      *w = gsl_vector_complex_float_const_subvector_with_stride( get(), i, stride, n ).vector;
      return vector_complex_float( w );
    }
