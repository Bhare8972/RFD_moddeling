...
namespace gsl {
  ...
  public:
     ...
     * you should not use gsl_vector_complex_free() to deallocate the memory.
     ...
     */
    vector_complex( std::initializer_list<std::complex<float> > initializer_list ){
	...
	*p = complex( std::move( x ) ); ++p;
    ...
    // clone()
    /**
     * The clone function. Use this if you want a copy of the vector_complex that does
    ...
    /**
     * Move constructor.
     * @param v The vector_complex to move.
     */
    vector_complex( vector_complex&& v ) : ccgsl_pointer( v.ccgsl_pointer ), count( nullptr ){
  ...
  public:
     ...
     * @param b The vector_complex
     * @param offset The offset within the vector_complex
    ...
    /**
     * Another C++ version of gsl_vector_complex_const_view_array().
     * @param v An array of type double
     * @param n The size of the vector_complex
     * @return A vector_complex
     */
    ...
    /**
     * Another C++ version of gsl_vector_complex_const_view_array_with_stride().
     * @param base An array of type double
     * @param stride The stride
     * @param n The size of the vector_complex
     * @return A vector_complex
    ...
    /**
     * Another C++ version of gsl_vector_complex_const_subvector().
     * @param i The offset
     * @param n The size
     * @return A subvector
     */
    ...
    /**
     * Another C++ version of gsl_vector_complex_const_subvector_with_stride().
     * @param i The offset
     * @param stride The stride
     * @param n The size
     * @return A subvector
