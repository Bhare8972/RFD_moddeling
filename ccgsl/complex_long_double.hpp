/*
 * $Id: complex_long_double.hpp 77 2012-01-15 15:32:13Z jdl3 $
...
namespace gsl {
   ...
   */
  class complex_long_double : public gsl_complex_long_double {
 ...
 public:
     ...
     * @return std::complex<long double> version of this (by copying).
     */
#ifdef __GXX_EXPERIMENTAL_CXX0X__
    explicit operator std::complex<long double>() const {
      return std::move( std::complex<long double>( GSL_REAL( *this ), GSL_IMAG( *this ) ) );
    }
#else
      operator std::complex<long double>() const {
      std::complex<long double> z = std::complex<long double>( GSL_REAL( *this ), GSL_IMAG( *this ) );
      return z;
    }
#endif      
    /**
