/*
 * $Id: multifit_function.hpp 233 2012-08-08 19:44:28Z jdl3 $
...
#ifndef CCGSL_MULTIFIT_FUNCTION_HPP
#define CCGSL_MULTIFIT_FUNCTION_HPP
...
namespace gsl {
  namespace multifit {
    /**
     * Class that extends gsl_multifit_function so that it can be constructed
     * from arbitrary function objects. Since gsl::multifit::function
     * is a subclass of gsl_multifit_function,
     * a pointer to an object of this class can be used whenever a pointer
     * to a gsl_multifit_function
     * object is required. Thus, pointers to objects of this class can be
     * used directly with the GNU
     * Scientific Library.
     *
     * A multifit::function with argument a vector of length @em n should compute and return
     * @em n function values. In C++ it is straightforward to set up a class with
     * a member function that
     * implements multifit::function::concept to get a suitable function object.
     * The multifit::function can
     * then be constructed from a function object of this class.
     */
    class function : public gsl_multifit_function {
    public:
      /**
	...
	size_t const n;
	/**
	 * A static function that gsl::multifit::function can use.
	 * This function must not be called in two threads at once.
	 * @param x The arguments of the functions.
	...
	count = 0; // initially nullptr will do
      ...
      /**
       * Could construct from a gsl_multifit_function. This constructor is not actually visible, but
       * gsl::multifit::function<T>() will construct the object correctly.
       * @param v The gsl_multifit_function.
       */
      explicit function( gsl_multifit_function& v ){
	...
	*count = 1; // initially there is just one reference to function
       ...
       * @param t An object that implements gsl::multifit::function::concept.
       */
      template<typename T>
	...
	*count = 1; // initially there is just one reference to function
       ...
       * gsl::multifit::function::multifit::function<T>() will construct the object correctly.
    ...
    inline void function_constructor( function& f, function& v ){
      f.func = v.func; f.count = v.count; f.f = v.f; f.n = v.n; f.p = v.p;
      f.params = v.params; if( f.count != 0 ) ++*f.count;
      /* function is now shared. */ }
    /**
     * Specialisation for gsl_multifit_function.
     * @param f The function.
     * @param v The function to use for f.
     */ 
    template<>
    inline void function_constructor( function& f, gsl_multifit_function& v ){
      f.f = v.f; f.n = v.n; f.p = v.p; f.params = v.params; }
    /**
     ...
     * gsl_multifit_function object; and copy construction.
     * @param f The function.
    ...
    /**
     * Make a gsl::multifit::function from a function object
     * that implements gsl::multifit::function::concept.
